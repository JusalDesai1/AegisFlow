...
const NDRFDashboard = () => {
  return (
    <div className="space-y-6 p-6">
      <Text as="h2" variant="h2">NDRF Operations Dashboard</Text>
      <Card padding="lg" variant="elevated">
        <Flex direction="col" gap="md">
          <Text variant="body">Unit Dispatch Console</Text>
          <div className="h-96 bg-gradient-to-b from-aegis-darker to-slate-900 rounded border border-aegis-border flex items-center justify-center">
            <Text color="tertiary">Dispatch Interface - Coming Soon</Text>
          </div>
        </Flex>
      </Card>
    </div>
